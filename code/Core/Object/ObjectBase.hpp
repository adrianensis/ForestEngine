...
class ObjectBase: public IObjectMetadata, public IMemoryTrackedObject, public ISerializable, public IPoolable, public IPointedObject, public EnablePtrFromThis
{
private:
