...
bool GPUCommandPool::init(GPUContext* gpuContext, VkCommandPoolCreateFlags creationFlags)
{
...
std::vector<GPUCommandBuffer> GPUCommandPool::allocateCommandBuffers(GPU::u32 count) const
{
