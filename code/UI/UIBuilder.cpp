...
void UIBuilder::registerUIElement(SharedPtr<UIElement> uiElement)
{
	mCurrentUIElement = uiElement;

	GET_SYSTEM(ScenesManager).getCurrentScene()->addGameObject(SharedPtr<GameObject>::cast(mCurrentUIElement));
