...
void UIElement::setColorPressed()
{
    ...
    mRenderer->getMaterialInstance().mMaterialPropertiesBlockBuffer.get<MaterialPropertiesBlock>().mMaterialLightingModelPhong.mDiffuse = mConfig.mStyle->mColorPressed;
}
...
void UIElement::setColorRelease()
{
    ...
    bool cursorInside = isMouseCursorInsideElement();
    mRenderer->getMaterialInstance().mMaterialPropertiesBlockBuffer.get<MaterialPropertiesBlock>().mMaterialLightingModelPhong.mDiffuse = cursorInside ? mConfig.mStyle->mColorHovered : mConfig.mStyle->mBackgroundColor;
}
