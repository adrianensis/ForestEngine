...
public:
    ...
    void addVertices(const vf32 vec);
    void addNormals(const vf32 vec);
    void addTextureCoordinates(const vf32 vec);
    void addColors(const vf32 vec);
    void addFaces(const vu16 vec);
