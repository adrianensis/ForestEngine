...
class GPUVertexInputBufferData
{
public:
...
public:
    void init(u32 vertexCount, u32 indicesCount, const std::vector<GPUVertexInputBufferData>& gpuVertexInputBuffers);
...
public:
    ...
    std::vector<GPUVertexInputBufferData> mGPUVertexInputBuffers;
