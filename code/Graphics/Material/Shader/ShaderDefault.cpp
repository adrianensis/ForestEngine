...
{
    auto& inColor = shaderBuilder.get().getAttribute(GPUBuiltIn::FragmentInput::mColor);
...
void ShaderDefault::generateShaderGenerationData(ShaderGenerationData& shaderGenerationData, const GPUVertexBuffersContainer& gpuVertexBuffersContainer) const
{
    ...
    //         // {
    //         //     shaderGenerationData.mVertexVariables.mUniforms.push_back(GPUBuiltIn::Uniforms::getTextureHandler(samplerName));
    //         // }
    //         // break;
    //         case GPUPipelineStage::FRAGMENT:
    //         {
    //             shaderGenerationData.mFragmentVariables.mUniforms.push_back(GPUBuiltIn::Uniforms::getTextureHandler(samplerName));
    //         }
    //         break;
...
void ShaderDefault::registerFragmentShaderData(ShaderBuilder& shaderBuilder, const GPUVertexBuffersContainer& gpuVertexBuffersContainer, GPUShaderDescriptorSets* gpuShaderDescriptorSets) const
{
    ...
    {
        shaderGenerationData.mFragmentVariables.mSamplers.push_back(GPUBuiltIn::Uniforms::getTextureHandler(*it));
        shaderBuilder.get().attribute(Attribute(GPUBuiltIn::Uniforms::getTextureHandler(*it),gpuShaderDescriptorSets->mGPUShaderDescriptorSetsBindings.mBindings.at(*it)));
    }
