...
void Shader::addVector4(const Vector4& value, const String& name)
{
	u32 location = glGetUniformLocation(mProgram, name.c_str());
...
void Shader::addVector3(const Vector3& value, const String& name)
{
	u32 location = glGetUniformLocation(mProgram, name.c_str());
...
void Shader::addVector2(const Vector2& value, const String& name)
{
	u32 location = glGetUniformLocation(mProgram, name.c_str());
