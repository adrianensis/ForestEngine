...
public:
	...
	CPP bool testSphere(const Vector3& center, f32 radius) const
	{
		bool result = true;
	...
	CPP bool testPoint(const Vector3& point) const
	{
		bool result = true;
	...
	CPP bool testRectangle(const Vector3& leftTop, f32 width, f32 height) const
	{
